...
<head>';
	echo ' <link rel="shortcut icon" href="http://competition.compfest.web.id/favicon.ico" />';
	...
	if ( $enable_favicon  )
			{
		echo '<link rel="shortcut icon" type="image/x-icon" href="http://competition.compfest.web.id/favicon.ico" />';
					 echo '<link rel="icon" href="http://competition.compfest.web.id/favicon.ico" type="image/x-icon" />';
			}
...
function template_body_above()
{
	...
	<div id="main_body">';
		...
		if (empty($context['current_board']) & $_GET['action'] == '' )
		echo '
...
function template_body_below()
{
	...
	<div id="footer">
		<ul class="reset">
			<li class="copyright"><div id="footer_logo"></div></li>
			<li class="copyright">', theme_copyright(), '</li>
			<li class="copyright"><strong>Blue Compfest</strong> Design By <a href="http://itsupport2013.github.io" target="_blank">Compfest IT-Support</a> team | based on <strong>Inferno</strong> Design By <a href="http://www.dzinerstudio.com" target="_blank">DzinerStudio</a></li>
