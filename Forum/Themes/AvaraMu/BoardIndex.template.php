		...
		echo '
				...
				<tr>
					<td class="windowbg" width="20" valign="middle" align="center">
						<a href="', $scripturl, '?action=recent"><img src="', $settings['images_url'], '/icons/recent.gif" alt="', $txt[214], '" /></a>
					</td>
					<td class="windowbg2">';
			...
			foreach ($context['latest_posts'] as $post)
				echo '
							<tr>
                              ...
                              <td class="middletext" valign="top">(', $post['board']['link'], ') <b>', $post['link'], '</b> ', $txt[525], ' ', $post['poster']['link'], ' ', $txt[30], ' ', $post['time'],'</td>
							</tr>';
			echo '
						</table>';
		}
